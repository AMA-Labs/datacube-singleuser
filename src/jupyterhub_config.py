...
# c.GoogleOAuthenticator.client_id='551477690645-a756lhvngh0i0mj8nqolj2v9b0laaeb8.apps.googleusercontent.com'
# c.GoogleOAuthenticator.client_secret='wt_F5rSoR7rei4n3MKLMXT9i'
# c.GoogleOAuthenticator.oauth_callback_url='http://localhost:8080/jh/hub/oauth_callback'
# c.GoogleOAuthenticator.hosted_domain = ['immap.org']

# c.GoogleOAuthenticator.login_service = 'iMMAP Login'
...
c.JupyterHub.base_url = os.environ.get('JH_BASE_URL','/')
...
# Using Postgres
# db_url = f"postgresql+psycopg2://{os.environ.get('DB_USERNAME','odc')}:{os.environ.get('DB_PASSWORD','odc')}@{os.environ.get('DB_HOSTNAME','db')}/jhub"
...
#  
#  .. versionadded:: 0.9
# c.JupyterHub.hub_bind_url = '0.0.0.0:8000'
...
# shutdown the server after no activity for 6 hours
c.NotebookApp.shutdown_no_activity_timeout = 360 * 60
# shutdown kernels after no activity for 6 hours
c.MappingKernelManager.cull_idle_timeout = 360 * 60
# check for idle kernels every 30 minutes
...
c.Authenticator.admin_users = {os.environ.get('NB_USR','odc_admin')}
...
# Github Config
#------------------------------------------------------------------------------
# c.GitHubConfig.access_token = os.environ.get('GITHUB_ACCESS_TOKEN','None')
# c.GitHubConfig.client_id = os.environ.get('GITHUB_CLIENT_ID','None')
# c.GitHubConfig.client_secret = os.environ.get('GITHUB_CLIENT_SECRET','None')